 ...
 * @param {string | null} [tonapi_key]
 * @returns {Promise<string>}
 */
export function scrape_wallet(address, network, tonapi_key) {
    ...
    var ptr2 = isLikeNone(tonapi_key) ? 0 : passStringToWasm0(tonapi_key, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    var len2 = WASM_VECTOR_LEN;
    const ret = wasm.scrape_wallet(ptr0, len0, ptr1, len1, ptr2, len2);
    return ret;
}
 ...
 * @returns {Promise<string>}
 */
export function scrape_wallets(addresses_json, network, tonapi_key) {
    ...
    var ptr2 = isLikeNone(tonapi_key) ? 0 : passStringToWasm0(tonapi_key, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    var len2 = WASM_VECTOR_LEN;
    const ret = wasm.scrape_wallets(ptr0, len0, ptr1, len1, ptr2, len2);
    return ret;
}
 ...
 * @returns {string}
 */
export function wallet_scraper_version() {
    let deferred1_0;
    let deferred1_1;
    try {
        const ret = wasm.wallet_scraper_version();
        deferred1_0 = ret[0];
        deferred1_1 = ret[1];
...
export function __wbg_fetch_e9a4f80db08af502(arg0) {
...
export function __wbindgen_cast_0000000000000001(arg0, arg1) {
    // Cast intrinsic for `Closure(Closure { dtor_idx: 162, function: Function { arguments: [Externref], shim_idx: 163, ret: Result(Unit), inner_ret: Some(Result(Unit)) }, mutable: true }) -> Externref`.
